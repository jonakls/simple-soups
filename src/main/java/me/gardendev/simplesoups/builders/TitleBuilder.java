...
public class TitleBuilder {
    ...
    public void send(Player player) {
        PacketPlayOutTitle packet1 = new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.TIMES, IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + title + "\"}"), this.fadeIn, this.stay, this.fadeOut);
        PacketPlayOutTitle packet2 = new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.TIMES, IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + subTitle + "\"}"), this.fadeIn, this.stay, this.fadeOut);
